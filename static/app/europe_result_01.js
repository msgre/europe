...
App.module("Result", function(Mod, App, Backbone, Marionette, $, _) {
  var BadTimeView, GreatTimeView, IDLE_DELAY, LETTERS, LETTER_BACKSPACE, LETTER_ENTER, NAME_MAX_LENGTH, Name, Rank, ResultLayout, Score, Time, TypewriterView, format_results, handler, layout, name, rank, time, _options;
