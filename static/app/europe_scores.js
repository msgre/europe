...
App.module("Scores", function(Mod, App, Backbone, Marionette, $, _) {
  var Categories, Category, CategoryResultItemView, CategoryResultView, NoResultsView, Result, Results, ScoreLayout, TitleView, _options, categories, handler, index, layout;
